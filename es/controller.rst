...
Los controladores son la 'C' en MVC. Después de que el enrutamiento ha sido 
aplicado y el controlador correcto ha sido encontrado, la acción de su 
controlador es llamada. Su controlador debe manejar la interpretación de los
datos solicitados, asegurando que los modelos correctos son llamados, y que la 
respuesta o vista correcta es renderizada. Los controladores pueden ser pensados
como el hombre en el medio (middle man) entre los Modelos y las Vistas. Usted 
querrá mantaner el controlador delgado y sus modelos gordos. Esto le ayudará a 
reutilizar su código más fácilmente y hace su código más fácil de probar.
